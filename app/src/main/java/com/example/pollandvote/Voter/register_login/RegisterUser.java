...
public class RegisterUser extends AppCompatActivity {
    ...
    public void addToFireStore(String email, String password, String fullName){
        ...
        // Add a new document
        db.collection("VoterRegister").document(email)
                .set(registrationModule).addOnSuccessListener(unused -> Toast.makeText(RegisterUser.this, "Success...", Toast.LENGTH_SHORT).show()).addOnFailureListener(e -> Toast.makeText(RegisterUser.this, "Failed...", Toast.LENGTH_SHORT).show());
